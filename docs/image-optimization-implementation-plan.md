...
const imageModules = import.meta.glob(
	['/static/**/*.{jpg,jpeg,png,webp,avif}', '/static/**/*.{JPG,JPEG,PNG,WEBP,AVIF}'],
	{
...
_Questo piano garantisce un'implementazione solida, type-safe e performante del sistema di ottimizzazione immagini, mantenendo la coerenza con l'architettura esistente del progetto._
